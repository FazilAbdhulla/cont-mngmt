<?php
/**
 * Title: Island 3 Columns
 * Slug: Assignment One/island-3-columns
...
<p class="has-text-align-center has-text-color has-work-sans-regular-font-family" style="color:#212121;margin-top:0px;margin-bottom:1.77rem;font-size:0.91rem;font-style:normal;font-weight:500;line-height:1.5"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'feel their ability to work remotely has improved*', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
