 ...
 * Slug: Assignment One/nature-services
...
<h1 class="wp-block-heading has-text-color" style="color:#345c01;font-size:6rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Services', 'Assignment One' ) ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
...
<div class="wp-block-group alignwide" style="padding-top:4.51rem;padding-right:0;padding-bottom:4.51rem;padding-left:0"><!-- wp:media-text {"align":"wide","mediaPosition":"right","mediaId":188,"mediaType":"image","style":{"spacing":{"padding":{"right":"0","left":"0"},"blockGap":{"top":"2.01rem","left":"2.71rem"},"margin":{"right":"0","left":"0"}}}} -->
<div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile" style="margin-right:0;margin-left:0;padding-right:0;padding-left:0"><div class="wp-block-media-text__content"><!-- wp:group {"style":{"spacing":{"padding":{"right":"2.71rem","left":"0","top":"4.51rem","bottom":"4.51rem"},"blockGap":"0.6rem"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:4.51rem;padding-right:2.71rem;padding-bottom:4.51rem;padding-left:0"><!-- wp:heading {"textAlign":"left","style":{"typography":{"fontSize":"2.26rem"}}} -->
<h2 class="wp-block-heading has-text-align-left" style="font-size:2.26rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Web Design', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'We create custom web design for small businesses, this will help you capture new audiences and increase your sales. Contact us by calling, emailing or filling out our form. You will receive a free quote by email within 24 hours.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-left" style="font-size:2.26rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Graphic Design', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'We specialize in logos, merchandise and more. Anyone can create nice graphics but it’s much better to create memorable ones. Contact us by calling, emailing or filling out our form. You will receive a free quote by email within 24 hours.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile" style="margin-right:0;margin-left:0;padding-right:0;padding-left:0"><div class="wp-block-media-text__content"><!-- wp:group {"style":{"spacing":{"padding":{"right":"2.71rem","left":"0","top":"4.51rem","bottom":"4.51rem"},"blockGap":"0.6rem"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:4.51rem;padding-right:2.71rem;padding-bottom:4.51rem;padding-left:0"><!-- wp:heading {"textAlign":"left","style":{"typography":{"fontSize":"2.26rem"}}} -->
<h2 class="wp-block-heading has-text-align-left" style="font-size:2.26rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Content Writing', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Want to attract people to your website? You have to have the best content in the world. Our content writers will create award willing content for you. Contact us by calling, emailing or filling out our form. You will receive a free quote by email within 24 hours.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:pattern {"slug":"Assignment One/nature-call-to-action"} /-->