 ...
 * Slug: Assignment One/nature-about
...
<h1 class="wp-block-heading has-text-color" style="color:#345c01;font-size:6rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'About', 'Assignment One' ) ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
...
<h2 class="wp-block-heading has-text-align-left" style="font-size:2.26rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'OUR MISSION', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Hello, my name is Tyler Moore and with the help of many people I made this template. I made it so it is super easy to update and so that it flows perfectly with my tutorials. Lots of love and hundreds of hours went into making it. I hope you love it as much as I do.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'I wish you the best of luck with your business, enjoy the adventure.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div></div>
<!-- /wp:media-text --></div>
<!-- /wp:group -->
