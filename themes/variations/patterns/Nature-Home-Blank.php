 ...
 * Slug: Assignment One/nature-home-blank
...
<h2 class="wp-block-heading has-text-align-center has-text-color" style="color:#000001"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Add a Subheading POTENTIAL', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"center","level":1,"style":{"color":{"text":"#000001"}}} -->
<h1 class="wp-block-heading has-text-align-center has-text-color" style="color:#000001"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'H1 Heading', 'Assignment One' ) ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"2.75rem"}},"color":{"text":"#000001"}}} -->
<p class="has-text-align-center has-text-color" style="color:#000001;margin-bottom:2.75rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Create a compelling and attention-grabbing short description<br>that sparks curiosity and leaves readers intrigued.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center has-text-color" style="color:#000001;margin-top:2.71rem;margin-bottom:2.71rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Services Heading', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->
...
<h4 class="wp-block-heading" style="margin-top:1.75rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'First Service', 'Assignment One' ) ); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"1.75rem"}},"color":{"text":"#000001"}}} -->
<p class="has-text-color" style="color:#000001;margin-bottom:1.75rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Craft a brief description outlining the essence of your first service.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-font-size is-style-outline" style="font-size:1.01rem;font-style:normal;font-weight:500;line-height:1.5"><a class="wp-block-button__link has-text-color wp-element-button" style="border-top-style:none;border-top-width:0px;border-right-color:#fffffd;border-bottom-width:2px;border-left-style:none;border-left-width:0px;color:#000001;padding-top:0;padding-right:0px;padding-bottom:0;padding-left:0px"><?php echo esc_html_x( 'CTA Button', 'sample content for call to action button', 'Assignment One' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<div class="wp-block-button has-custom-font-size is-style-outline" style="font-size:1.01rem;font-style:normal;font-weight:500"><a class="wp-block-button__link has-text-color wp-element-button" style="border-top-style:none;border-top-width:0px;border-right-color:#fffffd;border-bottom-width:2px;border-left-style:none;border-left-width:0px;color:#000001;padding-top:0;padding-right:0px;padding-bottom:0;padding-left:0px"><?php echo esc_html_x( 'CTA Button', 'sample content for call to action button', 'Assignment One' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<p class="has-text-align-center has-text-color" style="color:#000001;margin-bottom:1.75rem;font-size:35px;line-height:1.3"><?php printf( esc_html__( '%s', 'Assignment One' ), __( '"A comprehensive testimonial will be thoughtfully placed here, complete with all the compelling details and thoughtful insights."', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-center has-text-color" style="color:#000001;margin-top:16px;margin-bottom:0;font-style:normal;font-weight:300"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Full Name', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-center has-text-color" style="color:#000001;margin-top:0;margin-bottom:0;font-size:14px;font-style:normal;font-weight:300"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Job Title', 'Assignment One' ) ); ?></p>
...
<h2 class="wp-block-heading has-text-color" style="color:#000001;margin-top:0;margin-bottom:0"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'About Heading', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"2.75rem"}},"color":{"text":"#000001"}}} -->
<p class="has-text-color" style="color:#000001;margin-bottom:2.75rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'About Text: In this section, you can provide a detailed paragraph that delves into the history, values, and mission of your web development business. Highlight your team’s expertise, unique approach, and the commitment that sets you apart. Emphasize your passion for creating exceptional web solutions and convey your dedication to delivering remarkable results for clients.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center has-text-color" style="color:#000001"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Talk To Us Heading', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"2.75rem"}},"color":{"text":"#000001"}}} -->
<p class="has-text-align-center has-text-color" style="color:#000001;margin-bottom:2.75rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Text: In this section, you can compose a friendly and informative paragraph that encourages visitors to engage with your business.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
