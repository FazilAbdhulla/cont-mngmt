 ...
 * Slug: Assignment One/island-about-page-title
...
<h2 class="wp-block-heading has-text-align-center has-text-color has-prata-regular-font-family" style="color:#07277c;margin-top:0rem;margin-bottom:1.01rem;font-size:3.71rem;font-style:normal;font-weight:400;line-height:1"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'About The Island', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->