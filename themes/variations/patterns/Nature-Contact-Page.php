 ...
 * Slug: Assignment One/nature-contact
...
<h1 class="wp-block-heading has-text-color" style="color:#345c01;font-size:6rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Contact', 'Assignment One' ) ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->

<!-- wp:pattern {"slug":"Assignment One/nature-contact-section"} /-->