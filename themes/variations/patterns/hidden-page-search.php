...
/**
 * Title: Search Page
 * Slug: Assignment One/page-search
 * Inserter: no
 */
...
<!-- wp:post-excerpt {"moreText":"<?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Read more', 'Assignment One' ) ); ?>"} /-->
...
<p class="has-medium-font-size" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:2.01rem;padding-right:0;padding-bottom:2.01rem;padding-left:0"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Sorry, nothing was found for that search term.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
