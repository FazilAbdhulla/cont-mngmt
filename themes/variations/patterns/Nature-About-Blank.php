 ...
 * Slug: Assignment One/nature-about-blank
...
<h1 class="wp-block-heading has-text-align-center has-text-color" style="color:#000001"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'About', 'Assignment One' ) ); ?></h1>
<!-- /wp:heading -->
...
<div class="wp-block-columns alignwide" style="margin-top:4.51rem;margin-bottom:4.51rem;padding-top:2.01rem;padding-right:2.01rem;padding-bottom:2.01rem;padding-left:2.01rem"><!-- wp:column -->
...
<h2 class="wp-block-heading" style="margin-top:0;margin-bottom:0"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'About Heading', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->
