 ...
 * Slug: Assignment One/footer-columns
...
<p style="font-size:1.13rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Please connect our social media resources to stay in touch and receive all the recent info about us. Thank you for being part of our community!', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-color" style="color:#0693e4;font-size:1.01rem"><?php printf(
	esc_html__( 'Assignment One by %s | All rights reserved | Powered by WordPress', 'Assignment One' ),
