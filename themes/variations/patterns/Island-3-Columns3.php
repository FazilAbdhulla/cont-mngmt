<?php
/**
 * Title: Island 3 Columns3
 * Slug: Assignment One/island-3-columns3
...
<h2 class="wp-block-heading has-text-align-center has-text-color has-prata-regular-font-family" style="color:#07277c;margin-bottom:3.01rem;font-size:2.71rem;font-style:normal;font-weight:500;line-height:1.3"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Testimonials', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-text-color has-link-color has-work-sans-regular-font-family" style="color:#161616;margin-top:0px;font-size:0.85rem;font-style:normal;font-weight:500;line-height:1.5;text-transform:uppercase"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Edgar Santana', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
