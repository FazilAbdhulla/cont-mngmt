...
/**
 * Title: Lush Header
 * Slug: Assignment One/lush-header
...
?>
<!-- wp:group {"style":{"spacing":{"padding":{"bottom":"30px","top":"30px","left":"1rem","right":"1rem"},"margin":{"top":"0","bottom":"0"},"blockGap":"0"},"position":{"type":"sticky","top":"0px"},"dimensions":{"minHeight":""},"color":{"background":"#eaf4e8"}},"layout":{"type":"constrained","contentSize":"1200px","wideSize":"1200px"}} -->
<div class="wp-block-group has-background" style="background-color:#eaf4e8;margin-top:0;margin-bottom:0;padding-top:30px;padding-right:1rem;padding-bottom:30px;padding-left:1rem"><!-- wp:columns {"isStackedOnMobile":false,"style":{"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"},"margin":{"top":"0px","bottom":"0px"},"blockGap":{"top":"0px","left":"0px"}}}} -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%"><!-- wp:heading {"style":{"color":{"text":"#2b3c2c"},"elements":{"link":{"color":{"text":"#2b3c2c"}}},"typography":{"fontSize":"18px","fontStyle":"normal","fontWeight":"700"}}} -->
<h2 class="wp-block-heading has-text-color has-link-color" style="color:#2b3c2c;font-size:18px;font-style:normal;font-weight:700">Lush</h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<div class="wp-block-group"><!-- wp:navigation {"customTextColor":"#2b3c2c","icon":"menu","layout":{"type":"flex","justifyContent":"center"},"style":{"typography":{"fontSize":"18px"}},"fontFamily":"poppins"} /-->
