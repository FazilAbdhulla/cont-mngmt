 ...
 * Slug: Assignment One/nature-contact-blank
...
<h1 class="wp-block-heading has-text-align-center has-text-color" style="color:#000001"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Contact', 'Assignment One' ) ); ?></h1>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-custom-color-1-color has-text-color" style="padding-bottom:12px;font-size:35px"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'You can find us at', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->
...
<h5 class="wp-block-heading" style="font-size:23px;font-style:normal;font-weight:500"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'PHONE', 'Assignment One' ) ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php printf( esc_html__( '%s', 'Assignment One' ), __( '+123 456 7890', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"8px"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":5,"style":{"typography":{"fontSize":"23px","fontStyle":"normal","fontWeight":"500"}}} -->
<h5 class="wp-block-heading" style="font-size:23px;font-style:normal;font-weight:500"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'EMAIL', 'Assignment One' ) ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'email@website.com', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"8px"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":5,"style":{"typography":{"fontSize":"23px","fontStyle":"normal","fontWeight":"500"}}} -->
<h5 class="wp-block-heading" style="font-size:23px;font-style:normal;font-weight:500"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'ADDRESS', 'Assignment One' ) ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php printf( esc_html__( '%s', 'Assignment One' ), __( '2727 Ocean Road, Malibu, CA, 90264', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Let\'s Get in Touch', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'This is where you put in your contact form.  You can download a contact form plugin then insert the shortcode.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->