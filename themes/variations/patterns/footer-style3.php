 ...
 * Slug: Assignment One/footer-style3
...
<p style="font-style:normal;font-weight:500"><a href="#"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Download', 'Assignment One' ) ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}}} -->
<p style="font-style:normal;font-weight:500"><a href="#"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Website', 'Assignment One' ) ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}}} -->
<p style="font-style:normal;font-weight:500"><a href="#"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Facebook', 'Assignment One' ) ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}}} -->
<p style="font-style:normal;font-weight:500"><a href="#"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'YouTube', 'Assignment One' ) ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-text-align-center has-text-color has-link-color" style="color:#345c01;font-size:1.01rem;font-style:normal;font-weight:500"><?php printf(
	esc_html__( '© Copyright 2023 | Assignment One by %s', 'Assignment One' ),
	'<a href="' . esc_url( __( 'https://tyler.com/', 'Assignment One' ) ) . '" rel="nofollow" data-type="link" data-id="' . esc_url( __( 'https://tyler.com/', 'Assignment One' ) ) . '">Tyler Moore</a>'
); ?></p>
<!-- /wp:paragraph -->
