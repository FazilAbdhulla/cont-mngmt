...
/**
 * Title: Nature Hero
 * Slug: Assignment One/nature-hero
...
<h2 class="wp-block-heading has-text-align-center has-text-color" style="color:#2c541d;font-size:6rem;font-style:normal;font-weight:500"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'EARTH', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-text-color" style="color:#000001;margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;font-size:1.77rem;font-style:normal;font-weight:200;letter-spacing:0.3rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'ENDLESS POTENTIAL', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
