 ...
 * Slug: Assignment One/nature-contact-section
...
<h2 class="wp-block-heading"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Contact', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->
...
<p><?php printf( esc_html__( '%s', 'Assignment One' ), __( '(310) 736-8445', 'Assignment One' ) ); ?></p>
...
<p><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'example@gmail.com', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:media-text -->
...
<p><?php printf( esc_html__( '%s', 'Assignment One' ), __( '2727 Beach Rd.<br>Malibu, CA 90264', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:media-text -->
...
<p style="margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0"><strong><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Follow Us:', 'Assignment One' ) ); ?></strong></p>
<!-- /wp:paragraph -->
