...
/**
 * Title: Island Footer
 * Slug: Assignment One/island-footer
...
<p class="has-text-color has-link-color has-work-sans-regular-font-family" style="color:#03081e;font-size:1rem;text-decoration:none"><a href="mailto:#"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'info@Island.com', 'Assignment One' ) ); ?></a></p>
<!-- /wp:paragraph -->
...
<p class="has-text-color has-link-color has-work-sans-regular-font-family" style="color:#03081e;font-size:1rem;text-decoration:none"> <a href="tel:#"><?php printf( esc_html__( '%s', 'Assignment One' ), __( '+123456789', 'Assignment One' ) ); ?></a></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"style":{"typography":{"textDecoration":"none","fontSize":"1rem"},"color":{"text":"#03081e"},"elements":{"link":{"color":{"text":"#03081e"},":hover":{"color":{"text":"#03081e"}}}}},"fontFamily":"work-sans-regular"} -->
<p class="has-text-color has-link-color has-work-sans-regular-font-family" style="color:#03081e;font-size:1rem;text-decoration:none"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'Seesreasse 21, Zurich', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<p class="has-text-align-left has-text-color has-link-color has-work-sans-regular-font-family" style="color:#03081e;font-size:1rem;text-decoration:none"><?php printf( esc_html__( '%s', 'Assignment One' ), __( '© 2023 Island. All rights reserved.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->