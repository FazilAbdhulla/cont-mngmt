...
<p><?php echo esc_html_x( 'Posted', 'Verb to explain the publication status of a post', 'Assignment One' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:post-date /-->

<!-- wp:paragraph -->
<p><?php echo esc_html_x( 'in', 'Preposition to show the relationship between the post and its categories', 'Assignment One' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:paragraph -->
<p><?php echo esc_html_x( 'by', 'Preposition to show the relationship between the post and its author', 'Assignment One' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:paragraph -->
<p><?php echo esc_html_x( 'Tags:', 'Label for a list of post tags', 'Assignment One' ); ?></p>
<!-- /wp:paragraph -->
