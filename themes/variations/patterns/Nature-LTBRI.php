 ...
 * Slug: Assignment One/nature-libri
...
<h2 class="wp-block-heading has-text-align-left" style="font-size:2.26rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'ABOUT US', 'Assignment One' ) ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"fontSize":"1.13rem"}}} -->
<p style="font-size:1.13rem"><?php printf( esc_html__( '%s', 'Assignment One' ), __( 'I made it so it is super easy to update and so that it flows perfectly with my tutorials. Lots of love and hundreds of hours went into making it. I hope you love it as much as I do. I wish you the best of luck with your business, enjoy the adventure.', 'Assignment One' ) ); ?></p>
<!-- /wp:paragraph -->
